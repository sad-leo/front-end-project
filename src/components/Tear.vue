...
section .side#side1 {
  clip-path: polygon(0% 0%, 52% 0%, 34% 21%, 51% 38%, 33% 52%, 51% 68%, 33% 83%, 51% 100%, 0% 100%);
}
section .side#side2 {
  clip-path: polygon(0% 0%, 52% 0%, 34% 21%, 51% 38%, 33% 52%, 51% 68%, 33% 83%, 51% 100%, 0% 100%, 100% 100%, 100% 0%);
}
</style>